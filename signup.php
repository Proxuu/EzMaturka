...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        if ($stmt_check->num_rows > 0) {
            $username_err = "Konto z podanym adresem e-mail już istnieje.";
        } else {
            ...
            if ($stmt->execute()) {
                ...
                if ($user && password_verify($password, $user['password'])) {
                    ...
                    header('Location: demo-exercise.php');
                    exit;
                } else {
...
<head>
    ...
    <title>ezMaturka | Strona rejestracji</title>
            ...
            <div id="main-login-box">
                ...
                <div id="login-form-box">
                    <form id="login-form" method="post">
                        <h3>E-mail</h3>
                        <input class="login-inputs" type="email" name="username" placeholder="Twój email" maxlength="30" required>
                        <br>
                        <span class="error"><?php echo $username_err; ?></span>

                        <h3>Hasło</h3>
                        <input class="login-inputs" type="password" name="password" placeholder="Twoje hasło" maxlength="20" required>
                        <br>
                        <span class="error"><?php echo $password_err; ?></span>

                        <h3>Powtórz hasło</h3>
                        <input class="login-inputs" type="password" name="confirm_password" placeholder="Twoje hasło" maxlength="20" required>
                        <br>
